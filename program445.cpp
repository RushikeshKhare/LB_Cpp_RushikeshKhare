...
int main()
{
    ...
    cout<<"Singlye Circular Linkedlist"<<"\n";

    SinglyCL<int>*isobj = new SinglyCL<int>(); 

    isobj->InsertFirst(51);
    isobj->InsertFirst(21);
    isobj->InsertFirst(11);
    isobj->InsertFirst(10);
    isobj->Display();

    isobj->InsertAtPos(101,3);
    isobj->Display();
    ...
    dobj->Display();
    iRet = dobj->Count();
    cout<<"there are "<<iRet<< " nodes in the LinkedList"<<"\n";
